...
class GUI:
    ...
    def login(self):
        ...
        self.labelPwd = Label(self.login, text="Password: ", font=("Comic Sans MS", 12, "bold"))
    ...
    def usr_log_in(self, var_usr_name, var_usr_pwd):
        ...
        if usr_name in usrs_info:
            if usr_pwd == usrs_info[usr_name]:
                ...
                self.wel = Label(self.gopage, text="Welcome to Our Chatroom!", font=("Comic Sans MS", 14, "bold"))
                self.wel.place(x=60, y=65)
                self.go = Button(self.gopage, text="CONTINUE", font=("Comic Sans MS", 14, "bold"), command=lambda: self.goAhead(self.login_name))
